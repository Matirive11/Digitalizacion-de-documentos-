...
<body class="bg-white min-h-screen flex justify-center items-center">
    ...
    <div class="bg-white border-4 border-blue-800 w-full max-w-4xl text-blue-600 p-6 rounded-lg shadow-xl fade-in relative">
        ...
        <div class="bg-white text-black p-6 rounded mb-6 transition-opacity duration-500">
            <p class="text-lg leading-relaxed">
                Gracias por elegir esta casa de estudios donde podrá forjar su futuro. 
                Sus aspiraciones de superación serán acompañadas por el personal de esta institución, 
                quien le brindará las herramientas necesarias, desde su capacitación profesional y dedicación, 
        ...
        <div class="text-center">
            @auth
                <a href="{{ route('complete-profile') }}" 
                   class="bg-blue-800 text-white font-bold py-3 px-6 rounded transition-colors duration-300 hover:bg-blue-900">
